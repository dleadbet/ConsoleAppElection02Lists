...
namespace ConsoleAppElection02Lists
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Step 5 Add the names from the votes cast to a list.  This would be the fourth and final list needed.
            ...
            //Step 6 Loop through the list of Candidates and loop through the list of names on the votes cast to determine the VoteCount of each candidate
